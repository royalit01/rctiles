...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_storage'])) {
    ...
    // Prepare and bind
    $stmt = $mysqli->prepare("INSERT INTO storage_areas (storage_area_name, location) VALUES (?, ?)");
    $stmt->bind_param("ss", $storage_name, $location);
    ...
    if ($stmt->execute()) {
        ...
        $message = 'Error adding storage area: ' . $stmt->error;
    }
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="POST">
                                    ...
                                    <button type="submit" name="add_storage" class="btn btn-primary">Add Storage Area</button>
                                </form>
                            </div>
                        </div>
                        <!-- ---------------------------------------->
