...
<head>
    ...
    <title>Minus Stock – RC Mall</title>
...
<div id="layoutSidenav_content">
    <main class="py-4">
        <div class="container-fluid">
            <h2 class="mb-4">Orders Waiting for Stock Deduction</h2>
                    ...
                    <?php $i = 1; while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td class="text-nowrap">
                                <?php if (($row['total_delivered'] + $row['total_subtracted']) >= $row['total_ordered'] && $row['total_ordered'] > 0): ?>
                                    <span class="badge bg-success">Stock Updated</span>
                                    <button type="button" class="btn btn-sm btn-outline-danger ms-1 delete-order"
                                            data-order="<?= $row['order_id'] ?>" title="Remove record">
                                        <i class="fa fa-trash"></i>
                                    </button>
                                <?php else: ?>
                                    <button type="button" class="btn btn-sm btn-danger minus-stock-btn"
